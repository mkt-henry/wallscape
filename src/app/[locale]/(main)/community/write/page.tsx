...
const CATEGORY_KEYS: { key: BoardCategory; tKey: string }[] = [
  { key: 'general', tKey: 'catFree' },
  { key: 'question', tKey: 'catQuestion' },
  { key: 'meetup', tKey: 'catMeeting' },
  { key: 'tips', tKey: 'catTip' },
  { key: 'showcase', tKey: 'catBrag' },
]
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="sticky top-0 z-20 bg-background/90 backdrop-blur-md pt-safe-top border-b border-border/40">
        <div className="max-w-3xl mx-auto px-4 flex items-center justify-between h-14">
          ...
          <h1 className="text-white font-semibold">{t('writeTitle')}</h1>
          <button
      ...
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-6">
        {/* Category */}
        <div>
          <label className="text-text-secondary text-sm font-medium mb-2 block">{t('category')}</label>
