    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="sticky top-0 z-20 bg-background/90 backdrop-blur-md pt-safe-top">
        <div className="flex items-center justify-between px-4 h-14">
          ...
          <h1 className="text-white font-semibold">{t('editTitle')}</h1>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className={`mt-1.5 text-xs px-1 ${
              ...
              {usernameStatus === 'invalid' && t('handleInvalid')}
              {usernameStatus === 'taken' && t('handleTaken')}
              {usernameStatus === 'available' && t('handleAvailable')}
              {usernameStatus === 'idle' && t('handleHint')}
            </p>
          </div>
