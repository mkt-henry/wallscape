...
function SearchContent() {
  ...
  const SEARCH_TABS: { key: SearchType; label: string; icon: React.ReactNode }[] = [
    { key: 'posts', label: t('posts'), icon: <Hash size={16} /> },
    { key: 'users', label: t('users'), icon: <UserIcon size={16} /> },
    { key: 'tags', label: t('tags'), icon: <Hash size={16} /> },
    { key: 'locations', label: t('locations'), icon: <MapPin size={16} /> },
  ]
                  ...
                  >
                    ...
                    <div className="flex-1 text-left">
                      ...
                      <p className="text-text-secondary text-sm">
                        {t('postCountUnit', { count: tag.post_count.toLocaleString() })}
                      </p>
                    </div>
                  </button>
                ))}
