...
export default function AdminDashboard() {
  ...
  // Fetch all items and compute stats from full data set
        ...
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-xl bg-gradient-to-br from-primary to-orange-400 flex items-center justify-center">
          ...
          {FILTER_TABS.map(({ key, label }) => {
            ...
            return (
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 tap-highlight-none active:scale-95 ${
                  isActive
